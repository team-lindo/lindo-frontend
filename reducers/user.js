...
const userSlice = createSlice({
    ...
    reducers: {
        ...
        logOut(state) {
          ...
          state.logOutLoading = false; // 상태 초기화
        },
        setLogOutLoading(state, action) {
          state.logOutLoading = action.payload; // 상태 업데이트
        },
    },
});
...
import axiosInstance from './mockedAxiosInstance'; // Mocked Axios Instance Import
...
export const removeFollower = createAsyncThunk('user/removeFollower', async (data) => {
  const response = await axiosInstance.delete(`/user/follower/${data}`);
  return response.data;
});

export const loadFollowings = createAsyncThunk('user/loadFollowings', async () => {
  const response = await axiosInstance.get('/user/followings');
  return response.data;
});

export const loadFollowers = createAsyncThunk('user/loadFollowers', async () => {
...
export const follow = createAsyncThunk('user/follow', async (data) => {
  const response = await axiosInstance.patch(`/user/${data}/follow`);
  return response.data;
});
...
export const changeNickname = createAsyncThunk('user/changeNickname', async (data) => {
  const response = await axiosInstance.patch('/user/nickname', { nickname: data });
  return response.data;
});
